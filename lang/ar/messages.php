...
return [
    ...
    'candidateOnly'       => 'هذا المورد مخصص للباحثين عن عمل فقط',
    ...
    'profileUpdatedSuccessfully'     => 'تم تحديث البيانات المهنية بنجاح',
    'documentUploadedSuccessfully'   => 'تم رفع المستند بنجاح',
    'videoUploadedSuccessfully'      => 'تم رفع الفيديو التعريفي بنجاح',
    ...
    'candidateNotApproved'         => 'لا يمكن إرسال طلب تواصل لهذا الباحث عن العمل لأن حسابه غير معتمد (قيد المراجعة أو مرفوض)',
